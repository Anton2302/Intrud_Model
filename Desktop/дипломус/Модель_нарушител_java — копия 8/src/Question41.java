...
public class Question41 extends JFrame {

    public Question41()
    {
        JFrame frame = new JFrame("Вопрос 41 из 43");
        ...
        JLabel label2 = new JLabel("Происходит ли переодическая проверка");
        JLabel label3 = new JLabel("на устаревание компонентов ИС?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q41.txt", false))
                {
                    fileWriter.write("1");
                }
