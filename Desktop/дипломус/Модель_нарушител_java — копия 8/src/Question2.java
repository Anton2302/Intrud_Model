...
public class Question2 extends JFrame {
    ...
    public Question2()
    {
        JFrame frame = new JFrame("Вопрос 2 из 43");
        ...
        JLabel label2 = new JLabel("Присутствует ли в организации грид-система? ");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q2.txt", false))
                {
                    fileWriter.write("1");
                }
