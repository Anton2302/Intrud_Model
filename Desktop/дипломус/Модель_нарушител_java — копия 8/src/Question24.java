...
public class Question24 extends JFrame {
    ...
    public Question24()
    {
        JFrame frame = new JFrame("Вопрос 24 из 43");
        ...
        JLabel label2 = new JLabel("Используются ли в ИС линейные ");
        JLabel label3 = new JLabel("генераторы шума(линия заземления и 220В, и т.д.)?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q24.txt", false))
                {
                    fileWriter.write("1");
                }
