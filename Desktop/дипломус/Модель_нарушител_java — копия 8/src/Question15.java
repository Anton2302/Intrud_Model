...
public class Question15 extends JFrame {
    ...
    public Question15()
    {
        JFrame frame = new JFrame("Вопрос 15 из 43");
        ...
        JLabel label2 = new JLabel("Показываются ли пользователю отчеты об");
        JLabel label3 = new JLabel("ошибках в подробном виде?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q15.txt", false))
                {
                    fileWriter.write("1");
                }
