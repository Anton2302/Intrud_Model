...
public class Question30 extends JFrame {

    public Question30()
    {
        JFrame frame = new JFrame("Вопрос 30 из 43");
        ...
        JLabel label2 = new JLabel("Используются ли в ИС программы, с помощью");
        JLabel label3 = new JLabel("которых присутствует возможность создания");
        JLabel label4 = new JLabel("скриптов или макросов?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q30.txt", false))
                {
                    fileWriter.write("1");
                }
