...
public class Question10 extends JFrame {
    ...
    public Question10()
    {
        JFrame frame = new JFrame("Вопрос 10 из 43");
        ...
        JLabel label2 = new JLabel("Осуществляется ли мониторинг обновлений");
        JLabel label3 = new JLabel("и проверка на наличие НДВ в библиотках");
        JLabel label4 = new JLabel("и фреймворках кода ПО?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q10.txt", false))
                {
                    fileWriter.write("1");
                }
