...
public class Question22 extends JFrame {
    ...
    public Question22()
    {
        JFrame frame = new JFrame("Вопрос 22 из 43");
        ...
        JLabel label2 = new JLabel("Существует ли возможность использование");
        JLabel label3 = new JLabel("пользователями мобильных устройств для");
        JLabel label4 = new JLabel("получения информации?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q22.txt", false))
                {
                    fileWriter.write("1");
                }
