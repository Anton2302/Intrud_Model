...
public class Question35 extends JFrame {

    public Question35()
    {
        JFrame frame = new JFrame("Вопрос 35 из 43");
        ...
        JLabel label2 = new JLabel("Взаимодействует ли ИС");
        JLabel label3 = new JLabel("с другими системами?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q35.txt", false))
                {
                    fileWriter.write("1");
                }
