...
public class Question12 extends JFrame {
    ...
    public Question12()
    {
        JFrame frame = new JFrame("Вопрос 12 из 43");
        ...
        JLabel label2 = new JLabel("Имеет ли пользователь возможность посылать");
        JLabel label3 = new JLabel("запросы в ИС?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q12.txt", false))
                {
                    fileWriter.write("1");
                }
