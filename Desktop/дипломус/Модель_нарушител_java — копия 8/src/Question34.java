...
public class Question34 extends JFrame {

    public Question34()
    {
        JFrame frame = new JFrame("Вопрос 34 из 43");
        ...
        JLabel label2 = new JLabel("Присутсвует ли экранирование данных?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q34.txt", false))
                {
                    fileWriter.write("1");
                }
