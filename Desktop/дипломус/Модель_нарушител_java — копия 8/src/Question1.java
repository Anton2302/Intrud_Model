...
public class Question1 extends JFrame {
    ...
    public Question1()
    {
        JFrame frame = new JFrame("Вопрос 1 из 43");
        ...
        JLabel label2 = new JLabel("Хранятся ли в ИС данные, которые могут");
        JLabel label3 = new JLabel("быть потенциально полезными для служб ");
        JLabel label4 = new JLabel("иностранных государств?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q1.txt", false))
                {
                    fileWriter.write("1");
                }
