...
public class Question32 extends JFrame {

    public Question32()
    {
        JFrame frame = new JFrame("Вопрос 32 из 43");
        ...
        JLabel label2 = new JLabel("Имеют ли соответствующие лицензии организации,");
        JLabel label3 = new JLabel("которые привлекаются на договорной основе");
        JLabel label4 = new JLabel("для разработки и (или) производства");
        JLabel label5 = new JLabel("средств и систем защиты?");;
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q32.txt", false))
                {
                    fileWriter.write("1");
                }
