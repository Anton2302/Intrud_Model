...
public class Question14 extends JFrame {
    ...
    public Question14()
    {
        JFrame frame = new JFrame("Вопрос 14 из 43");
        ...
        JLabel label2 = new JLabel("Присутствует ли проверка целостности");
        JLabel label3 = new JLabel("XML-системы?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q14.txt", false))
                {
                    fileWriter.write("1");
                }
