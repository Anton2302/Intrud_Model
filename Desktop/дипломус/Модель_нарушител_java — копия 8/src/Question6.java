...
public class Question6 extends JFrame {
    ...
    public Question6()
    {
        JFrame frame = new JFrame("Вопрос 6 из 43");
        ...
        JLabel label2 = new JLabel("Имеется ли физический доступ к системным");
        JLabel label3 = new JLabel("блокам компьютеров у работников организации,");
        JLabel label4 = new JLabel("не являющихся обслуживающим персоналом ИС?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q6.txt", false))
                {
                    fileWriter.write("1");
                }
