...
public class Question8 extends JFrame {
    ...
    public Question8()
    {
        JFrame frame = new JFrame("Вопрос 8 из 43");
        ...
        JLabel label3 = new JLabel("и проверка на наличие НДВ для BIOS/UEFI?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q8.txt", false))
                {
                    fileWriter.write("1");
                }
