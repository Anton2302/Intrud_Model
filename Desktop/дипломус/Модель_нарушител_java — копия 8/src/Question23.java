...
public class Question23 extends JFrame {
    ...
    public Question23()
    {
        JFrame frame = new JFrame("Вопрос 23 из 43");
        ...
        JLabel label2 = new JLabel("Используется ли в ИС волоконно-оптическая");
        JLabel label3 = new JLabel("система передачи данных?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q23.txt", false))
                {
                    fileWriter.write("1");
                }
