...
public class Question5 extends JFrame {
    ...
    public Question5()
    {
        JFrame frame = new JFrame("Вопрос 5 из 43");
        ...
        JLabel label2 = new JLabel("Имеется ли ПОЛНАЯ доверенность к лицам,");
        JLabel label3 = new JLabel("обеспечивающим функционирование системы? ");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q5.txt", false))
                {
                    fileWriter.write("1");
                }
