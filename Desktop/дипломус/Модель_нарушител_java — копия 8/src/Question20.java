...
public class Question20 extends JFrame {
    ...
    public Question20()
    {
        JFrame frame = new JFrame("Вопрос 20 из 43");
        ...
        JLabel label2 = new JLabel("Присутствует ли в системе механизмы");
        JLabel label3 = new JLabel("резервирования средств обработки, хранения");
        JLabel label4 = new JLabel("и передачи информации, входящей в состав");
        JLabel label5 = new JLabel("облачной ИС?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q20.txt", false))
                {
                    fileWriter.write("1");
                }
