...
public class Question18 extends JFrame {
    ...
    public Question18()
    {
        JFrame frame = new JFrame("Вопрос 18 из 43");
        ...
        JLabel label2 = new JLabel("Включает ли политика лицензирвания использование");
        JLabel label3 = new JLabel("активации ПО определнное кол-во раз?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q18.txt", false))
                {
                    fileWriter.write("1");
                }
