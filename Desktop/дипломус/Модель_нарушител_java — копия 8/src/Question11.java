...
public class Question11 extends JFrame {
    ...
    public Question11()
    {
        JFrame frame = new JFrame("Вопрос 11 из 43");
        ...
        JLabel label2 = new JLabel("Производится ли проверка и анализ вводимых");
        JLabel label3 = new JLabel("пользователем данных?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q11.txt", false))
                {
                    fileWriter.write("1");
                }
