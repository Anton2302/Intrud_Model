...
public class Question38 extends JFrame {

    public Question38()
    {
        JFrame frame = new JFrame("Вопрос 38 из 43");
        ...
        JLabel label2 = new JLabel("Применяются ли в ИС виртуальные машины");
        JLabel label3 = new JLabel("и (или) облачные сервера?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q38.txt", false))
                {
                    fileWriter.write("1");
                }
