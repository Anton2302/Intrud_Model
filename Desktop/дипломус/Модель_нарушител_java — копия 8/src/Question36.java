...
public class Question36 extends JFrame {

    public Question36()
    {
        JFrame frame = new JFrame("Вопрос 36 из 43");
        ...
        JLabel label2 = new JLabel("Предусмотрена ли возможность удаленного");
        JLabel label3 = new JLabel("доступа в систему?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q36.txt", false))
                {
                    fileWriter.write("1");
                }
