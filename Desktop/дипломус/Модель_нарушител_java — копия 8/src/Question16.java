...
public class Question16 extends JFrame {
    ...
    public Question16()
    {
        JFrame frame = new JFrame("Вопрос 16 из 43");
        ...
        JLabel label2 = new JLabel("Осуществляется ли контроль за автоматически");
        JLabel label3 = new JLabel("создаваемыми копиями информации?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q16.txt", false))
                {
                    fileWriter.write("1");
                }
