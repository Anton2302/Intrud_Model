...
public class Question17 extends JFrame {
    ...
    public Question17()
    {
        JFrame frame = new JFrame("Вопрос 17 из 43");
        ...
        JLabel label2 = new JLabel("Осуществляется ли контроль за автоматическим");
        JLabel label3 = new JLabel("удалением данных?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q17.txt", false))
                {
                    fileWriter.write("1");
                }
