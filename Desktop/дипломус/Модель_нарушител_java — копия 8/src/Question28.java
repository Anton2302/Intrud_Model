...
public class Question28 extends JFrame {
    ...
    public Question28()
    {
        JFrame frame = new JFrame("Вопрос 28 из 43");
        ...
        JLabel label2 = new JLabel("Используются ли в ИС сетевые");
        JLabel label3 = new JLabel("помехоподавляющие фильтры?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q28.txt", false))
                {
                    fileWriter.write("1");
                }
