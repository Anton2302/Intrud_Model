...
public class Question31 extends JFrame {

    public Question31()
    {
        JFrame frame = new JFrame("Вопрос 31 из 43");
        ...
        JLabel label2 = new JLabel("Используются ли в ИС сертифицированные средства");
        JLabel label3 = new JLabel("виброакустической защиты?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q31.txt", false))
                {
                    fileWriter.write("1");
                }
