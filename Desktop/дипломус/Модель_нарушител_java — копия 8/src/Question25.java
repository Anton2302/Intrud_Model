...
public class Question25 extends JFrame {
    ...
    public Question25()
    {
        JFrame frame = new JFrame("Вопрос 25 из 43");
        ...
        JLabel label2 = new JLabel("Используются ли в ИС сертифицированные");
        JLabel label3 = new JLabel("генераторы пространственного зашумления?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q25.txt", false))
                {
                    fileWriter.write("1");
                }
