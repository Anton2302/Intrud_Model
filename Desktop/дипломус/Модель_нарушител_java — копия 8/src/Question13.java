...
public class Question13 extends JFrame {
    ...
    public Question13()
    {
        JFrame frame = new JFrame("Вопрос 13 из 43");
        ...
        JLabel label2 = new JLabel("Производится ли проверка целостности");
        JLabel label3 = new JLabel("cookie-файлов со стороны возможного ");
        JLabel label4 = new JLabel("дискредитируемого приложения");
        JLabel label5 = new JLabel("(если cookie не используются, то ответить да)?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q13.txt", false))
                {
                    fileWriter.write("1");
                }
