...
public class Question4 extends JFrame {
    ...
    public Question4()
    {
        JFrame frame = new JFrame("Вопрос 4 из 43");
        ...
        JLabel label3 = new JLabel("привлекаемым для установочных работ ИС?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q4.txt", false))
                {
                    fileWriter.write("1");
                }
