...
public class Question42 extends JFrame {

    public Question42()
    {
        JFrame frame = new JFrame("Вопрос 42 из 43");
        ...
        JLabel label2 = new JLabel("Присутствует ли комплекс мер по обеспечению");
        JLabel label3 = new JLabel("компонентов ИС от различного рода угроз,");
        JLabel label4 = new JLabel("не относящихся к человеческому фактору?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q42.txt", false))
                {
                    fileWriter.write("1");
                }
