...
public class Question29 extends JFrame {

    public Question29()
    {
        JFrame frame = new JFrame("Вопрос 29 из 43");
        ...
        JLabel label2 = new JLabel("Используются ли на компьютерах ИС дисковые ГМД");
        JLabel label3 = new JLabel("и (или) существует поддержка переносных");
        JLabel label4 = new JLabel("физических носителей информации?");
        ...
        ActionListener al_yes = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try(FileWriter fileWriter = new FileWriter("q29.txt", false))
                {
                    fileWriter.write("1");
                }
